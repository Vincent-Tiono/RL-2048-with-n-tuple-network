...
class Game2048Env(gym.Env):
    ...
    def get_afterstate(self, action):
        """Get the state after applying an action but before adding a random tile"""
        ...
        return afterstate, afterstate_score, moved
    ...
    def step(self, action):
        ...
        return self.board, self.score, done, {"afterstate": afterstate, "afterstate_score": afterstate_score}
